...
you should place your code here."
  ...
  (with-eval-after-load 'org
    ...
    (evil-define-key '(normal motion insert visual) org-mode-map (kbd "<f6>") 'org-babel-execute-src-block)
    (evil-define-key '(normal motion insert visual) org-mode-map (kbd "C-<f6>")
