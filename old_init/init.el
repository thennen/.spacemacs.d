...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(;;cl ;; not sure if this is causing problems, texmathp complained about need of cl at runtime
                                      ...
                                      smooth-scrolling ;; try to fix shitty/choppy scrolling
...
you should place your code here."
  ...
  ;; Try to remap l to s
  ;; want to effectively swap these characters in all modes.  This does not accomplish that.
  ...
  ;; Try to set up hh to go to normal mode.
  ;; Right now it does not work in any other mode than insert.
  ;; And won't work if you are recording a macro, which you have no indication of in emacs after a couple of seconds
  (require 'key-chord)
  ...
  (with-eval-after-load 'org
    ...
    (custom-set-variables
     '(org-directory org-base-path(setq org-latex-to-pdf-process 
